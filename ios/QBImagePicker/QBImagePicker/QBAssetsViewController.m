...
@property (nonatomic, strong) IBOutlet UIBarButtonItem *cancelButton;//更改为取消按钮
...
//    }
    ...
    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, ([UIScreen mainScreen].bounds.size.height - 64 - bottomSafeHeight), [UIScreen mainScreen].bounds.size.width, 64 + bottomSafeHeight)];
    bottomBar.backgroundColor = [UIColor colorWithRed:243.0/255 green:243.0/255 blue:243.0/255 alpha:1];
    [self.view addSubview:bottomBar];
    [self.view bringSubviewToFront:bottomBar];
    
    UIButton *doneBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [doneBtn setTitle:@"Done" forState:UIControlStateNormal];
    doneBtn.backgroundColor = [UIColor colorWithRed:40.0/255 green:120.0/255 blue:1 alpha:1];
    doneBtn.layer.masksToBounds = YES;
    doneBtn.layer.cornerRadius = 4.0;
    [doneBtn setFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width - 200)/2, 12,200,40)];
    [doneBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [doneBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateDisabled];
...
- (void)updateSelectionInfo
{
    ...
    if (selectedAssets.count > 0) {
        [self.doneButton setTitle:[NSString stringWithFormat:@"Done（%lu）",(unsigned long)selectedAssets.count] forState:UIControlStateNormal];
    } else {
...
- (void)updateDoneButtonState
{
    ...
    if (self.doneButton.isEnabled) {
        self.doneButton.backgroundColor = [UIColor colorWithRed:40.0/255 green:120.0/255 blue:1 alpha:1];
    }else{
        self.doneButton.backgroundColor = [UIColor colorWithRed:197.0/255 green:197.0/255 blue:197.0/255 alpha:1];
    }
}

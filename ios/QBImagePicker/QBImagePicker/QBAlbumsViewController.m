...
@property (nonatomic,strong) QBAssetsViewController *assetsViewController;
...
- (void)showAssetsViewController{
    UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"QBImagePicker" bundle:self.imagePickerController.assetBundle];
    if (self.assetsViewController == nil) {
        self.assetsViewController = (QBAssetsViewController*)[storyboard instantiateViewControllerWithIdentifier:@"QBAssetsViewController"];
        self.assetsViewController.imagePickerController = self.imagePickerController;
        self.assetsViewController.assetCollection = [self.assetCollections firstObject];
        [self.navigationController pushViewController:self.assetsViewController animated:NO];
    }else{
        self.assetsViewController.assetCollection = [self.assetCollections firstObject];
    }
}
...
{
    self.assetsViewController = segue.destinationViewController;
    self.assetsViewController.imagePickerController = self.imagePickerController;
    self.assetsViewController.assetCollection = self.assetCollections[self.tableView.indexPathForSelectedRow.row];
}
